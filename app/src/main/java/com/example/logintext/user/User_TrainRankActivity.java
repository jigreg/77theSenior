...
public class User_TrainRankActivity extends AppCompatActivity {
    ...
    private ListAdapter train_adapter;
    private List<Training> TempList = new ArrayList<>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.user_train_ranking);
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(User_TrainRankActivity.this, User_MainActivity.class));
                finish();
            }
        });
        ...
        walkRank.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(User_TrainRankActivity.this, User_WalkRankActivity.class));
                finish();
            }
        });

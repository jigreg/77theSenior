...
public class UserLocationActivity extends AppCompatActivity
    ...
    private static final int UPDATE_INTERVAL_MS = 30000;  // 10초
    //private static final int UPDATE_INTERVAL_MS = 300000;  // 300초
    // private static final int FASTEST_UPDATE_INTERVAL_MS = 300000; // 300초 ( 5분 )
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(UserLocationActivity.this, UserMainActivity.class));
                finish();
            }
        });
    ...
    public void onMapReady(final GoogleMap googleMap) {
        ...
        mReference.child("user").child(uid).child("myProtector").get().addOnCompleteListener(new OnCompleteListener<DataSnapshot>() {
                ...
                public void onComplete(@NonNull Task<DataSnapshot> task) {
                        ...
                        if (!myPro.equals("none")) {
                            mReference.child("protector").child(myPro).child("safeZone").addValueEventListener(new ValueEventListener() {
                                ...
                                public void onDataChange(@NonNull DataSnapshot snapshot) {
                                    try {
                                        ...
                                        Toast.makeText(UserLocationActivity.this, "안전구역은 미설정 상태입니다.", Toast.LENGTH_SHORT).show();
                                    }
                                }
                            ...
                            Toast.makeText(UserLocationActivity.this, "보호자를 등록해주세요.", Toast.LENGTH_SHORT).show();
                        }
                }
            });
        // 권한 처리 + 요청 결과는 onRequestPermissionResult에서 수신
        // 위치 권한 동의 여부 확인
        int hasFineLocationPermission = ContextCompat.checkSelfPermission(UserLocationActivity.this,
                Manifest.permission.ACCESS_FINE_LOCATION);
        int hasCoarseLocationPermission = ContextCompat.checkSelfPermission(UserLocationActivity.this,
        ...
        if (hasFineLocationPermission == PackageManager.PERMISSION_GRANTED &&
            ...
            // 권한 거부된 적이 있을 때
            if (ActivityCompat.shouldShowRequestPermissionRationale(UserLocationActivity.this, REQUIRED_PERMISSIONS[0])) {
                ...
                Snackbar.make(mLayout, "이 앱을 실행하려면 위치 접근 권한이 필요합니다.",
                    ...
                    public void onClick(View view) {
                        // 권한 요청
                        ActivityCompat.requestPermissions(UserLocationActivity.this, REQUIRED_PERMISSIONS,
    ...
    public void setCurrentLocation(Location location, String markerTitle, String markerSnippet) {
        ...
        markerOptions.position(currentLatLng);     // 마커 위치
        markerOptions.title(markerTitle);       // 마커 이름
        markerOptions.snippet(markerSnippet);   // 마커를 클릭했을 때 내용
        markerOptions.draggable(false); // 드래그 가능 여부

        currentMarker = mMap.addMarker(markerOptions); // markerOptions 정보로 마커 생성

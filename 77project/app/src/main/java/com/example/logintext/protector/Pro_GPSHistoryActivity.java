...
public class Pro_GPSHistoryActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.pro_gps_history);
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(Pro_GPSHistoryActivity.this, Pro_LocationActivity.class));
                finish();
            }
        });
        ...
        mReference.child("protector").child(uid).child("myUser").get().addOnCompleteListener(new OnCompleteListener<DataSnapshot>() {
            ...
            public void onComplete(@NonNull Task<DataSnapshot> task) {
                ...
                mReference.child("user").child(myUser).child("gps").addValueEventListener(new ValueEventListener() {
                    @Override

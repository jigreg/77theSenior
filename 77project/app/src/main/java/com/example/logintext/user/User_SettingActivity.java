...
public class User_SettingActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        association.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(User_SettingActivity.this, AppInfoActivity.class));
                finish();
            }
        });
        ...
        push_alram.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(User_SettingActivity.this, User_PushAlarmActivity.class));
                finish();
            }
        });
